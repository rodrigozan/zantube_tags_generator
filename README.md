...
![YouTube Video Tags Generator](https://raw.githubusercontent.com/rodrigozan/keywords_generator/master/YouTube%20Video%20Tags%20Generator.png)
...
- git clone
```bash
git clone https://github.com/rodrigozan/keywords_generator.git
```

- enter the project directory project direct

```bash
mkdir keywords_generator
```
